                    ...
                    <div className="dropdown">
                        ...
                        <ul tabindex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li tabindex="0">
                                ...
                                <ul className="p-2">
                                    <li><NavLink to=''>Nuestra Organizacion</NavLink></li>
                                    <li><NavLink to=''>Nuestro equipo</NavLink></li>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal p-0">
                        ...
                        <li tabindex="0">
                            ...
                            <ul className="card card-compact p-2 flex-row bg-white shadow-md">
                                <li>
                                    <NavLink to='/nosotros/'>
                                        <div class="card-body">
                        ...
                        <li tabindex="0">
                            ...
                            <ul className="p-2">
                                <li><NavLink to=''>Medellin Barrista</NavLink></li>
                                <li><NavLink to=''>Club deportivo TCP</NavLink></li>
                                <li><NavLink to=''>ES&SU</NavLink></li>
                                <li><NavLink to=''>Jovemp</NavLink></li>
                                <li><NavLink to=''>Liga Guayabal</NavLink></li>
                                <li><NavLink to=''>Torneo Barrial</NavLink></li>
                                <li><NavLink to=''>A.G.A</NavLink></li>
                                <li><NavLink to=''>Natural Woman</NavLink></li>
                                <li><NavLink to=''>Cronicas y pasion deportiva</NavLink></li>
                            </ul>
                        </li>
